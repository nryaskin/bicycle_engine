...
int main() {
    cpp::decl_specifier_seq_t constexpr_string(cpp::constexpr_specifier, cpp::simple_type_specifier_t("std::string"));

    // && c
    cpp::declarator_t c_value = cpp::rvalue_reference_declarator_t(cpp::unqualified_id_t("c"));
    ...
    cpp::init_declarator_list_t init_declarator_list;
    init_declarator_list.add(init_declarator);
